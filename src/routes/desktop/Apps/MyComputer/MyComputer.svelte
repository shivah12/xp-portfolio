<script>
	...
	function openGitHub() {
		window.open('https://github.com/shivah12', '_blank');
	}

	function openLinkedIn() {
		window.open('https://www.linkedin.com/in/shreeti-mohapatra-ba8715252/', '_blank');
	}

	function openBehance() {
		window.open('https://www.behance.net/shreetimohapatra', '_blank');
	}

	function openChattie() {
		window.open('https://github.com/shivah12/Chattie', '_blank');
	}

	function openResume() {
		window.open('https://drive.google.com/file/d/10hlp-EAVsixCLZzb2cAvaxIDGsOZc8Qk/view', '_blank');
	}
</script>

{#if showFolderView}
	<FolderView folderName={currentFolder} onClose={closeFolderView} />
{:else}
			...
			<div class="right">
				<div class="right__card">
					...
					<div class="right__card__content">
							<div class="right__card__item" on:click={() => handleFolderClick('coding projects')}>
							<img src={folder} alt="Shared Documents" class="right__card__img" />
							<div class="right__card__img-container">
									<div class="right__card__text">coding projects</div>
								</div>
							</div>
							<div class="right__card__item" on:click={() => handleFolderClick('design projects')}>
							<img src={folder} alt="User's Documents" class="right__card__img" />
							<div class="right__card__img-container">
									<div class="right__card__text">design projects</div>
								</div>
						</div>
					</div>
				</div>
				...
				<div class="right__card">
					...
					<div class="right__card__content">
						<div class="right__card__item" on:click={openGitHub}>
							<div class="right__card__img-container">
								<img src={floppyDisk} alt="GitHub" class="right__card__img" />
							</div>
							<div class="right__card__text">GitHub (A:)</div>
						</div>
						<div class="right__card__item" on:click={openLinkedIn}>
							<div class="right__card__img-container">
								<img src={floppyDisk} alt="LinkedIn" class="right__card__img" />
							</div>
							<div class="right__card__text">LinkedIn (B:)</div>
						</div>
						<div class="right__card__item" on:click={openBehance}>
							<div class="right__card__img-container">
								<img src={floppyDisk} alt="Behance" class="right__card__img" />
							</div>
							<div class="right__card__text">Behance (C:)</div>
						</div>
					</div>
				</div>
			</div>
